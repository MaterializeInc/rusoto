...
# Rusoto Kendra
Rust SDK for AWSKendraFrontendService
...
To use `mz_rusoto_kendra` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_kendra "API documentation"
