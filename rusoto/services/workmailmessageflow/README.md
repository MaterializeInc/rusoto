...
# Rusoto WorkmailMessageFlow
Rust SDK for Amazon WorkMail Message Flow
...
To use `mz_rusoto_workmailmessageflow` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_workmailmessageflow = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_workmailmessageflow "API documentation"
