...
# Rusoto ServiceQuotas
Rust SDK for Service Quotas
...
To use `mz_rusoto_service_quotas` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_service_quotas = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_service_quotas "API documentation"
