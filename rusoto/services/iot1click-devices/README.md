...
To use `mz_rusoto_iot1click_devices` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_iot1click_devices "API documentation"
