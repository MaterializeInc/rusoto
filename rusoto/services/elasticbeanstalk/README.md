...
To use `mz_rusoto_elasticbeanstalk` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_elasticbeanstalk = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_elasticbeanstalk "API documentation"
