...
# Rusoto IotThingsGraph
Rust SDK for AWS IoT Things Graph
...
To use `mz_rusoto_iotthingsgraph` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_iotthingsgraph = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_iotthingsgraph "API documentation"
