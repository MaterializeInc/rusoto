...
To use `mz_rusoto_sagemaker_runtime` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_sagemaker_runtime = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_sagemaker_runtime "API documentation"
