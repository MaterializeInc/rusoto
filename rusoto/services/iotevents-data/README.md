...
# Rusoto IotEventsData
Rust SDK for AWS IoT Events Data
...
To use `mz_rusoto_iotevents_data` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_iotevents_data = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_iotevents_data "API documentation"
