...
To use `mz_rusoto_waf_regional` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_waf_regional = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_waf_regional "API documentation"
