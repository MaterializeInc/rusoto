...
# Rusoto CodeGuruProfiler
Rust SDK for Amazon CodeGuru Profiler
...
To use `mz_rusoto_codeguruprofiler` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_codeguruprofiler = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_codeguruprofiler "API documentation"
