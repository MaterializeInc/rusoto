...
# Rusoto ConnectParticipant
Rust SDK for Amazon Connect Participant Service
...
To use `mz_rusoto_connectparticipant` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_connectparticipant = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_connectparticipant "API documentation"
