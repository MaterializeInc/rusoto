...
# Rusoto ApplicationInsights
Rust SDK for Amazon CloudWatch Application Insights
...
To use `mz_rusoto_application_insights` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_application_insights "API documentation"
