...
To use `mz_rusoto_cognito_sync` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_cognito_sync = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_cognito_sync "API documentation"
