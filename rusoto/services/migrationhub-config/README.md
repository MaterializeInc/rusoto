...
# Rusoto MigrationHubConfig
Rust SDK for AWS Migration Hub Config
...
To use `mz_rusoto_migrationhub_config` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_migrationhub_config = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_migrationhub_config "API documentation"
