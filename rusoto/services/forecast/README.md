...
# Rusoto Forecast
Rust SDK for Amazon Forecast Service
...
To use `mz_rusoto_forecast` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_forecast = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_forecast "API documentation"
