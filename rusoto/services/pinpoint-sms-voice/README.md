...
# Rusoto PinpointSmsVoice
Rust SDK for Amazon Pinpoint SMS and Voice Service
...
To use `mz_rusoto_pinpoint_sms_voice` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_pinpoint_sms_voice = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_pinpoint_sms_voice "API documentation"
