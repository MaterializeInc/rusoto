...
# Rusoto Sso
Rust SDK for AWS Single Sign-On
...
To use `mz_rusoto_sso` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_sso = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_sso "API documentation"
