...
To use `mz_rusoto_ec2_instance_connect` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_ec2_instance_connect "API documentation"
