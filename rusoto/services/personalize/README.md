...
# Rusoto Personalize
Rust SDK for Amazon Personalize
...
To use `mz_rusoto_personalize` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_personalize = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_personalize "API documentation"
