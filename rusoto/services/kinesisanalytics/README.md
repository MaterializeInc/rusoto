...
To use `mz_rusoto_kinesisanalytics` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_kinesisanalytics = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_kinesisanalytics "API documentation"
