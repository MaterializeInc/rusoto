...
# Rusoto Ebs
Rust SDK for Amazon Elastic Block Store
...
To use `mz_rusoto_ebs` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_ebs = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_ebs "API documentation"
