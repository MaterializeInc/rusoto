...
To use `mz_rusoto_codecommit` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_codecommit = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_codecommit "API documentation"
