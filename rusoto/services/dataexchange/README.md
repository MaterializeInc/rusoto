...
# Rusoto DataExchange
Rust SDK for AWS Data Exchange
...
To use `mz_rusoto_dataexchange` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_dataexchange = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_dataexchange "API documentation"
