...
# Rusoto IoTSecureTunneling
Rust SDK for AWS IoT Secure Tunneling
...
To use `mz_rusoto_iotsecuretunneling` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_iotsecuretunneling "API documentation"
