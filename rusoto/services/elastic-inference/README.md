...
# Rusoto ElasticInference
Rust SDK for Amazon Elastic  Inference
...
To use `mz_rusoto_elastic_inference` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_elastic_inference = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_elastic_inference "API documentation"
