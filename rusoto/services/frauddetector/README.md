...
# Rusoto FraudDetector
Rust SDK for Amazon Fraud Detector
...
To use `mz_rusoto_frauddetector` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_frauddetector = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_frauddetector "API documentation"
