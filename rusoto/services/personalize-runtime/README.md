...
# Rusoto PersonalizeRuntime
Rust SDK for Amazon Personalize Runtime
...
To use `mz_rusoto_personalize_runtime` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_personalize_runtime = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_personalize_runtime "API documentation"
