...
To use `mz_rusoto_cloudsearch` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_cloudsearch "API documentation"
