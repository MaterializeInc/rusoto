...
To use `mz_rusoto_kinesis_video_archived_media` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_kinesis_video_archived_media = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_kinesis_video_archived_media "API documentation"
