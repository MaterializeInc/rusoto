...
# Rusoto QldbSession
Rust SDK for Amazon QLDB Session
...
To use `mz_rusoto_qldb_session` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_qldb_session = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_qldb_session "API documentation"
