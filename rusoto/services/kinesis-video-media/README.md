...
To use `mz_rusoto_kinesis_video_media` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_kinesis_video_media "API documentation"
