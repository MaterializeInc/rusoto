...
# Rusoto NetworkManager
Rust SDK for AWS Network Manager
...
To use `mz_rusoto_networkmanager` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_networkmanager = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_networkmanager "API documentation"
