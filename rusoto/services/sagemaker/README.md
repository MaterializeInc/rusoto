...
To use `mz_rusoto_sagemaker` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_sagemaker = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_sagemaker "API documentation"
