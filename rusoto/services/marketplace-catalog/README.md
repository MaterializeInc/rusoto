...
To use `mz_rusoto_marketplace_catalog` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_marketplace_catalog "API documentation"
