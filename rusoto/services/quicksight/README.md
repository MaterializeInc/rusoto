...
# Rusoto Quicksight
Rust SDK for Amazon QuickSight
...
To use `mz_rusoto_quicksight` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_quicksight = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_quicksight "API documentation"
