...
# Rusoto CodeStarConnections
Rust SDK for AWS CodeStar connections
...
To use `mz_rusoto_codestar_connections` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_codestar_connections "API documentation"
