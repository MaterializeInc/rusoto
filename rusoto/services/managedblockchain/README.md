...
# Rusoto ManagedBlockchain
Rust SDK for Amazon Managed Blockchain
...
To use `mz_rusoto_managedblockchain` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_managedblockchain = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_managedblockchain "API documentation"
