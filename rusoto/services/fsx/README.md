...
To use `mz_rusoto_fsx` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_fsx = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_fsx "API documentation"
