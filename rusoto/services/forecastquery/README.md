...
# Rusoto ForecastQuery
Rust SDK for Amazon Forecast Query Service
...
To use `mz_rusoto_forecastquery` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_forecastquery = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_forecastquery "API documentation"
