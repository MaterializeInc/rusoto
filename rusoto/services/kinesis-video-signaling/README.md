...
# Rusoto KinesisVideoSignaling
Rust SDK for Amazon Kinesis Video Signaling Channels
...
To use `mz_rusoto_kinesis_video_signaling` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_kinesis_video_signaling = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_kinesis_video_signaling "API documentation"
