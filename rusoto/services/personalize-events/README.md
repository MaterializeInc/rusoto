...
# Rusoto PersonalizeEvents
Rust SDK for Amazon Personalize Events
...
To use `mz_rusoto_personalize_events` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_personalize_events = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_personalize_events "API documentation"
