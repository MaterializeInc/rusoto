...
# Rusoto CodeGuruReviewer
Rust SDK for Amazon CodeGuru Reviewer
...
To use `mz_rusoto_codeguru_reviewer` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_codeguru_reviewer = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_codeguru_reviewer "API documentation"
