...
# Rusoto Es
Rust SDK for Amazon Elasticsearch Service
...
To use `mz_rusoto_es` in your application, add it as a dependency in your `Cargo.toml`:
...
[api-documentation]: https://docs.rs/mz_rusoto_es "API documentation"
