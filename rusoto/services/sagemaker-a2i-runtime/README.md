...
# Rusoto SagemakerA2iRuntime
Rust SDK for Amazon Augmented AI Runtime
...
To use `mz_rusoto_sagemaker_a2i_runtime` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_sagemaker_a2i_runtime = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_sagemaker_a2i_runtime "API documentation"
