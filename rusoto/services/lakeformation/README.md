...
# Rusoto LakeFormation
Rust SDK for AWS Lake Formation
...
To use `mz_rusoto_lakeformation` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_lakeformation = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_lakeformation "API documentation"
