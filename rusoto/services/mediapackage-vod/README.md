...
# Rusoto MediaPackageVod
Rust SDK for AWS Elemental MediaPackage VOD
...
To use `mz_rusoto_mediapackage_vod` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_mediapackage_vod = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_mediapackage_vod "API documentation"
