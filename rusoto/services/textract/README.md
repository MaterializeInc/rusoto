...
To use `mz_rusoto_textract` in your application, add it as a dependency in your `Cargo.toml`:

```toml
[dependencies]
mz_rusoto_textract = "0.45.0"
```
...
[api-documentation]: https://docs.rs/mz_rusoto_textract "API documentation"
